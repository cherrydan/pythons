#
#
# Разворачивание и сворачивание окна в PyQt5
#
#
...
class MyWindow(QtWidgets.QWidget):
    ...
    def on_min(self):
            self.showMinimized() #минимизирует главное окно (self)

    def on_max(self):
            self.showMaximized() #максимизирует главное окно

    def on_full(self):
           self.showFullScreen() #раскрывает окно на весь экран

    def on_normal(self):
           self.showNormal() #восстанавливает окно в нормальном размере

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    window = MyWindow()
    window.setWindowTitle('Разворачиваем и сворачиваем окно')
